...
export type EquipmentSlot = 'mainHand' | 'offHand' | 'head' | 'body' | 'belt' | 'gloves' | 'boots' | 'necklace' | 'ringRight' | 'ringLeft';
export type SkillName = 'woodcutting' | 'mining' | 'fishing' | 'herbalism' | 'gathering' | 'smithing' | 'cooking' | 'alchemy' | 'oneHanded' | 'dualWield' | 'twoHanded' | 'ranged' | 'casting' | 'gun';
